package com.alf.config;

import com.alf.utils.FileTypeUtils;
import com.alf.utils.MailTask;
import com.alf.utils.Md5Utils;
...
public class MyMvcConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/aliyun/avatar/**").addResourceLocations("file:D:\\alf\\avatar\\");
        registry.addResourceHandler("/aliyun/file/**").addResourceLocations("file:D:\\alf\\files\\");
    }
