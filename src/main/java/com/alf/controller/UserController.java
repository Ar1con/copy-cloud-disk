package com.alf.controller;


import com.alf.model.User;
import com.alf.service.UserService;

import com.alf.utils.MailTask;
import com.alf.utils.Md5Utils;
import com.alf.utils.WebPageVo;
...
public class UserController {
    ...
    public WebPageVo uploadAvatar(@RequestParam("avatar") MultipartFile avatar, HttpSession session){
        ...
        // 创建删除文件对象
        File oldavatarfile = new File("D:\\alf\\avatar\\",oldAvatar.getNewavatarname());
        // 进行删除
