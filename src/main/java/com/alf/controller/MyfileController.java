...
import com.alf.model.Myfile;
import com.alf.service.MyfileService;
...
public class MyfileController {
    ...
    public void deleteAllFiles(Integer ids[]){
        for (Integer id : ids) {
            ...
            // 创建删除文件对象
            File file = new File("D:\\alf\\files\\",delfile.getNewfilename());
            // 进行删除
